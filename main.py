################################################################################
#
# Chess Tactics Creator
#
# Needed Changes
# * Input request for file name - default is game.pgn
#
#
################################################################################
...
def main(config_info):
    ...
    for pgn in games:
        ...
        print("Black Player: ", game.headers["Black"])
        print(pgn_event)
        print(pgn_site)
        print(pgn_date)
        print(pgn_round)
        ...
        if game.headers["White"] == player_name:
            player_color = "w"
            print("I am playing White")
        elif game.headers["Black"] == player_name:
            player_color = "b"
            print("I am playing Black")
        print(game.mainline())
